...
export default function Chat() {
  ...
  const [currentToUser, setCurrentToUser] = useState("Sankha");
  ...
  const ContactList = [
    {
      name: "Sankha",
      lastmessage: findLastMessage("Sankha"),
    },

    {
      name: "Aayushi",
      lastmessage: findLastMessage("Aayushi"),
    },
    {
      name: "Barnita",
      lastmessage: findLastMessage("Barnita"),
    },
    {
      name: "Happy",
